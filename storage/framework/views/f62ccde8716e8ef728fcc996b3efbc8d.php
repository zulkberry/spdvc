    ...
    <div class="flex flex-1 items-center justify-center">
        <div class="bg-[#202124] rounded-xl shadow-xl p-0 md:p-0 w-full max-w-2xl overflow-hidden flex">
            ...
            <div class="bg-[#202124] hidden md:flex items-center justify-center w-1/2 p-6">
                <img src="<?php echo e(asset('images/logo SPDVC.webp')); ?>" alt="Logo" class="h-20 md:h-24">
            </div>
                ...
                <form method="POST" action="<?php echo e(route('login.process')); ?>">
                    ...
                    <div class="flex justify-center mb-4 space-x-2">
                        ...
                        <a href="<?php echo e(route('google.login')); ?>"
                            ...
                            <img src="<?php echo e(asset('images/search.png')); ?>" alt="Google" class="w-5 h-5 mr-2">
                            Google
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/login.blade.php ENDPATH**/ ?>