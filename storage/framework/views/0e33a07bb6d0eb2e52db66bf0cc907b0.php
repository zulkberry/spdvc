...
<section class="max-w-6xl mx-auto bg-white rounded-xl shadow px-6 py-8 mt-6 mb-10">
    <h2 class="text-2xl font-bold italic text-black mb-6 flex items-center">
        <img src="<?php echo e(asset('images/Shape 2.webp')); ?>" class="h-8 mr-2" alt="">
        Hubungi Kami :
    </h2>
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="space-y-4">
            <div class="flex items-center space-x-3">
                <img src="<?php echo e(asset('images/Icon 6.webp')); ?>" class="h-6" alt="WA">
                <span class="text-lg font-semibold">0812-XXXX-XXXX</span>
            </div>

            <div class="flex items-start space-x-3">
                <img src="<?php echo e(asset('images/Icon 7.webp')); ?>" class="h-6 mt-1" alt="Maps">
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/kontak.blade.php ENDPATH**/ ?>