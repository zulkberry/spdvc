...
<div class="max-w-3xl mx-auto px-4 py-6 text-justify text-start text-[15px] leading-relaxed">
   <a href="<?php echo e(route('program.index')); ?>">← Kembali</a>

    <!-- Judul & Subjudul -->
    <div class="text-center mb-6">
        <div class="inline-block relative">
            <img src="<?php echo e(asset('images/Shape 4.webp')); ?>" alt="Program Magang Background" class="h-[64px] md:h-[80px]">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/program/magang-bersertifikat.blade.php ENDPATH**/ ?>