...
<div class="max-w-6xl mx-auto px-4 py-6 text-justify text-[15px] leading-relaxed">
    <div class="absolute top-6 left-6">
        <a href="<?php echo e(route('program.index')); ?>" class="text-black hover:underline">← Kembali</a>
    </div>  

    <!-- Judul Utama -->
    <div class="mb-8 flex justify-center">
        <div class="relative inline-block">
            <img src="<?php echo e(asset('images/Shape 4.webp')); ?>" alt="Background" class="h-[64px] md:h-[80px]">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/program/career-development.blade.php ENDPATH**/ ?>