{{-- resources/views/program/training.blade.php --}}
@extends('layouts.app')

@section('content')
<div class="max-w-3xl mx-auto px-4 py-6 text-justify text-[15px] leading-relaxed">
    <a href="{{ route('program.index') }}" class="text-sm text-black hover:underline block mb-4">← Kembali</a>

    <!-- Judul -->
    <div class="text-center mb-6">
        <div class="inline-block relative">
            <img src="{{ asset('images/Shape 4.webp') }}" alt="Training" class="h-[64px] md:h-[80px]">
