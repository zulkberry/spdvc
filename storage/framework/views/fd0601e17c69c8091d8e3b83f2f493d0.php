...
<?php $__env->startSection('content'); ?>
    ...
    <section class="max-w-4xl mx-auto text-center space-y-8">
        <div>
            <div class="relative inline-block">
                <img src="<?php echo e(asset('images/Shape 1.webp')); ?>" class="h-[32px] md:h-[40px]" alt="Visi">
        ...
        <div>
            <div class="relative inline-block">
                <img src="<?php echo e(asset('images/Shape 1.webp')); ?>" class="h-[32px] md:h-[40px]" alt="Misi">
    ...
    <section class="max-w-4xl mx-auto text-left mt-16 space-y-8">
        <div class="text-center">
            <div class="relative inline-block">
                <img src="<?php echo e(asset('images/Shape 1.webp')); ?>" class="h-[32px] md:h-[40px]" alt="Sejarah">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/tentang-kami.blade.php ENDPATH**/ ?>