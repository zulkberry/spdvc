...
<head>
  ...
  <div class="text-center mt-6 mb-4">
    <div class="relative inline-block">
      <img src="<?php echo e(asset('images/Shape 1.webp')); ?>" alt="Judul Background" class="h-[40px] md:h-[44px]">
  ...
  <div class="max-w-4xl mx-auto px-4 space-y-6">
    ...
    <div>
      <h4 class="font-bold text-black mb-1 flex items-center gap-2">
        <img src="<?php echo e(asset('images/Shape 2.webp')); ?>" alt="Icon Kecil" class="w-5 h-5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-spd\spdvsc\resources\views/program/teaching-factory.blade.php ENDPATH**/ ?>