    ...
    <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="relative w-full overflow-hidden">
            <div id="carousel-items" class="flex transition-transform duration-700 ease-in-out w-full">
                <?php $__currentLoopData = array_chunk($testimonis, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex w-full shrink-0 justify-center">
                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="w-full sm:w-1/2 lg:w-1/3 px-2 box-border">
                                <div class="bg-white p-6 rounded-lg shadow-md flex flex-col items-center min-h-[340px]">
                                    <img src="<?php echo e($t['gambar']); ?>" alt="Profile" class="w-16 h-16 rounded-full mb-4">
                                    <div class="text-yellow-400 mb-2">
                                        <?php for($i = 0; $i < $t['bintang']; $i++): ?> ★ <?php endfor; ?>
                                    </div>
                                    <p class="italic mb-4 text-sm text-center">“<?php echo e($t['pesan']); ?>”</p>
                                    <p class="font-semibold text-sm text-gray-700 mt-auto">- <?php echo e($t['nama']); ?> -</p>
                                </div>
                            </div>
